(() => {
        ...
        for (let a = 0; a < g; a += 1) {
          ...
          if (
            ...
            if ("auto" === i.slidesPerView) {
              ...
              (S = (s - (i.slidesPerView - 1) * A) / i.slidesPerView),
                i.roundLengths && (S = Math.floor(S)),
  ...
  const se = [
    function ({ swiper: e, extendParams: t, on: n, emit: a }) {
      ...
      function d(t) {
        ...
        const I = s ? -u.length : 0,
          L = s ? 2 * u.length : u.length;
        for (let e = I; e < L; e += 1)
          if (e >= v && e <= x) {
            const n = C(e);
            void 0 === c || t
    ...
    function ({ swiper: e, extendParams: t, on: n, emit: i }) {
      ...
      function C(t) {
        ...
        let r, s, o, l, p, c, h, f, y, v, x, M, E, A, T, C, I, L;
        e.params.cssMode &&
          ((e.wrapperEl.style.overflow = "hidden"),
  ...
  (() => {
    ...
    window.addEventListener("load", () => {
      ...
      const S = (e, t = 0, n = null, i = null, a = null, r = null, s = !1) => {
          if (null != e || null != e) {
            e.currentTime = t;
            let o = e.play();
            void 0 !== o &&
        ...
        k = new X(".gallery-background", {
          direction: "vertical",
          enabled: !1,
        }),
        N = new X(".gallery-swiper", {
          direction: "vertical",
          loop: !0,
          enabled: !1,
          spaceBetween: 10,
