(() => {
  ...
  function u({ swiper: e, targetPosition: t, side: n }) {
    ...
    const d = t > a ? "next" : "prev",
      ...
      c = () => {
        ...
        const r = Math.max(Math.min((o - s) / l, 1), 0),
  ...
  function w(e) {
    ...
    return { top: a.top + d - s, left: a.left + p - l };
  }
  function f(e, t) {
    ...
    I = {
      ...
      updateSlides: function () {
          ...
          if (
            ...
            if ("auto" === i.slidesPerView) {
              ...
              if (
                ...
                S = e.isHorizontal() ? x(r, "width", !0) : x(r, "height", !0);
              else {
                const e = n(o, "width"),
                  t = n(o, "padding-left"),
                  i = n(o, "padding-right"),
                ...
                if (l && "border-box" === l) S = e + a + s;
                  ...
                  const { clientWidth: n, offsetWidth: o } = r;
                  S = e + t + i + a + s + (o - n);
                }
              }
              ...
              (S = (o - (i.slidesPerView - 1) * A) / i.slidesPerView),
                i.roundLengths && (S = Math.floor(S)),
                u[a] && (u[a].style[t("width")] = `${S}px`);
        ...
        if (
          ...
          L && e.grid.updateWrapperSize(S, h, t),
          !i.centeredSlides)
        ) {
          const t = [];
      ...
      updateProgress: function (e) {
        ...
        let { progress: a, isBeginning: r, isEnd: o, progressLoop: s } = t;
        const l = r,
          d = o;
        if (0 === i) (a = 0), (r = !0), (o = !0);
        else {
      ...
      updateSlidesClasses: function () {
        const e = this,
          ...
          o = (e) => m(i, `.${n.slideClass}${e}, swiper-slide${e}`)[0];
        let s;
        if (
          (t.forEach((e) => {
            e.classList.remove(
  ...
  const S = {
    slideTo: function (e = 0, t = this.params.speed, n = !0, i, a) {
      ...
      if ((r.animating && s.preventInteractionOnTransition) || (!h && !i && !a))
        return !1;
      const w = Math.min(r.params.slidesPerGroupSkip, o);
      let f = w + Math.floor((o - w) / r.params.slidesPerGroup);
      ...
      let b;
      if (
        (o !== (p || 0) && n && r.emit("beforeSlideChangeStart"),
        r.updateProgress(y),
        ...
        return (
          ...
          "slide" !== s.effect && r.setTranslate(y),
    ...
    slideNext: function (e = this.params.speed, t = !0, n) {
      ...
      const l = i.activeIndex < r.slidesPerGroupSkip ? 1 : s,
    ...
    slidePrev: function (e = this.params.speed, t = !0, n) {
      ...
      const u = c(s ? i.translate : -i.translate),
        g = r.map((e) => c(e));
    ...
    slideToClosest: function (e = this.params.speed, t = !0, n, i = 0.5) {
      const a = this;
      let r = a.activeIndex;
      const o = Math.min(a.params.slidesPerGroupSkip, r),
        s = o + Math.floor((r - o) / a.params.slidesPerGroup),
        l = a.rtlTranslate ? a.translate : -a.translate;
      if (l >= a.snapGrid[s]) {
        const e = a.snapGrid[s];
        l - e > (a.snapGrid[s + 1] - e) * i && (r += a.params.slidesPerGroup);
      } else {
        const e = a.snapGrid[s - 1];
        l - e <= (a.snapGrid[s] - e) * i && (r -= a.params.slidesPerGroup);
      }
      return (
        (r = Math.max(r, 0)),
        ...
        (a = parseInt(
          ...
          t.centeredSlides
            ? r < e.loopedSlides - i / 2 ||
              ...
              ? (e.loopFix(),
                (r = e.getSlideIndex(
                  m(n, `${s}[data-swiper-slide-index="${a}"]`)[0]
                )),
                o(() => {
                  e.slideTo(r);
                }))
  ...
  function z(e) {
    ...
    u.matches(o.focusableElements) &&
      ((x = !1), "SELECT" === u.nodeName && (o.isTouched = !1)),
      n.activeElement &&
  ...
  function N(e) {
    const t = i(),
      n = this,
      a = n.touchEventsData,
      { params: r, touches: o, rtlTranslate: l, enabled: d } = n;
    if (!d) return;
    ...
    const u = a.evCache.length > 1 ? a.evCache[0] : p,
      g = u.pageX,
      m = u.pageY;
    if (p.preventedByNestedSwiper) return (o.startX = g), void (o.startY = m);
    if (!n.allowTouchMove)
      return (
    ...
    if (r.touchReleaseOnEdges && !r.loop)
      if (n.isVertical()) {
        if (
          (m < o.startY && n.translate <= n.maxTranslate()) ||
          (m > o.startY && n.translate >= n.minTranslate())
        )
          return (a.isTouched = !1), void (a.isMoved = !1);
      } else if (
        (g < o.startX && n.translate <= n.maxTranslate()) ||
        (g > o.startX && n.translate >= n.minTranslate())
      )
        return;
    if (
      t.activeElement &&
  ...
  const U = (e, t) => {
      const n = i(),
        { params: a, el: r, wrapperEl: o, device: s } = e,
        l = !!a.nested,
  ...
  const q = {
      ...
      translate: {
        ...
        setTranslate: function (e, t) {
          const n = this,
            { rtlTranslate: i, params: a, wrapperEl: r, progress: o } = n;
          let s,
            l = 0,
            d = 0;
          ...
          (s = 0 === p ? 0 : (e - n.minTranslate()) / p),
            s !== o && n.updateProgress(e),
        ...
        translateTo: function (
          ...
          if (
            ...
            const e = r.isHorizontal();
            if (0 === t) s[e ? "scrollLeft" : "scrollTop"] = -p;
            else {
              if (!r.support.smoothScroll)
                return (
                  u({
      ...
      loop: {
        ...
        loopFix: function ({
          ...
          if (
            ...
            return (
              t &&
                (u.centeredSlides || 0 !== s.snapIndex
                  ? u.centeredSlides && s.snapIndex < u.slidesPerView
                    ? s.slideTo(
          ...
          if (a < m) {
            ...
            x = Math.max(a - (s.slides.length - 2 * m), u.slidesPerGroup);
            for (let e = 0; e < x; e += 1) {
              const t = e - Math.floor(e / l.length) * l.length;
              w.push(t);
            }
          ...
          if (
            ...
            if (h.length > 0 && b)
              if (void 0 === e) {
                const e = s.slidesGrid[f],
                  t = s.slidesGrid[f + v] - e;
                o
                  ? s.setTranslate(s.translate - t)
                  : (s.slideTo(f + v, 0, !1, !0),
                    i &&
                      (s.touches[s.isHorizontal() ? "startX" : "startY"] += t));
              } else i && s.slideToLoop(e, 0, !1, !0);
            else if (w.length > 0 && y)
              if (void 0 === e) {
                const e = s.slidesGrid[f],
                  t = s.slidesGrid[f - x] - e;
                o
                  ? s.setTranslate(s.translate - t)
                  : (s.slideTo(f - x, 0, !1, !0),
                    i &&
          ...
          if (
            ((s.allowSlidePrev = d),
            (s.allowSlideNext = p),
            s.controller && s.controller.control && !r)
          ) {
            const t = {
              slideRealIndex: e,
              slideTo: !1,
      ...
      breakpoints: {
        setBreakpoint: function () {
          ...
          const s = (o in r ? r[o] : void 0) || e.originalParams,
            l = R(e, i),
            d = R(e, s),
            c = i.enabled;
          l && !d
            ...
            : !l &&
              ...
              ((s.grid.fill && "column" === s.grid.fill) ||
                (!s.grid.fill && "column" === i.grid.fill)) &&
          ...
          const u = s.direction && s.direction !== i.direction,
            g = i.loop && (s.slidesPerView !== i.slidesPerView || u);
          u && n && e.changeDirection(), p(e.params, s);
  ...
  class V {
    ...
    slidesPerViewDynamic(e = "current", t = !1) {
      ...
      if (n.centeredSlides) {
        ...
        for (let e = s + 1; e < i.length; e += 1)
          (t ? a[e] + r[e] - a[s] < o : a[e] - a[s] < o) && (l += 1);
      else for (let e = s - 1; e >= 0; e -= 1) a[s] - a[e] < o && (l += 1);
      return l;
    }
    update() {
      const e = this;
    ...
    destroy(e = !0, t = !0) {
      const n = this,
        { params: i, el: a, wrapperEl: r, slides: o } = n;
      return (
        void 0 === n.params ||
          n.destroyed ||
  ...
  function ee(e) {
    ...
    if ("object" == typeof e && "length" in e) {
      for (let n = 0; n < e.length; n += 1)
        (r = e[n]), t.slides[r] && t.slides[r].remove(), r < o && (o -= 1);
      o = Math.max(o, 0);
    } else
      (r = e),
  ...
  const oe = [
    function ({ swiper: e, extendParams: t, on: n, emit: a }) {
        ...
        return (
          i.renderSlide
            ? ((a = i.renderSlide.call(e, t, n)),
              "string" == typeof a && ((s.innerHTML = a), (a = s.children[0])))
            : (a = e.isElement
                ? h("swiper-slide")
      ...
      function d(t) {
        const {
          ...
          { addSlidesBefore: s, addSlidesAfter: d } = e.params.virtual,
        ...
        (f = e.rtlTranslate ? "right" : e.isHorizontal() ? "left" : "top"),
          r
            ? ((y = Math.floor(n / 2) + i + d), (b = Math.floor(n / 2) + i + s))
            : ((y = n + (i - 1) + d), (b = (o ? n : i) + s));
        let v = w - b,
          x = w + y;
        o || ((v = Math.max(v, 0)), (x = Math.min(x, u.length - 1)));
        ...
        const I = o ? -u.length : 0,
          L = o ? 2 * u.length : u.length;
        for (let e = I; e < L; e += 1)
          if (e >= v && e <= x) {
            const n = C(e);
            void 0 === c || t
    ...
    function ({ swiper: e, extendParams: t, on: n, emit: a }) {
      ...
      function d() {
        e.keyboard.enabled ||
          (o.addEventListener("keydown", l), (e.keyboard.enabled = !0));
      }
      function p() {
        e.keyboard.enabled &&
          (o.removeEventListener("keydown", l), (e.keyboard.enabled = !1));
      }
    ...
    function ({ swiper: e, extendParams: t, on: n, emit: i }) {
      ...
      function m(t) {
        return !(
          ...
          (e.params.mousewheel.thresholdTime &&
            s() - p < e.params.mousewheel.thresholdTime) ||
          (!(t.delta >= 6 && s() - p < 60) &&
            (t.direction < 0
      ...
      function h(t) {
        ...
        if (
          ...
          const t = { time: s(), delta: Math.abs(g), direction: Math.sign(g) },
            a =
              d &&
              t.time < d.time + 500 &&
              t.delta <= d.delta &&
          ...
          if (!a) {
            d = void 0;
            let s = e.getTranslate() + g * r.sensitivity;
    ...
    function ({ swiper: e, extendParams: t, on: n, emit: i }) {
      ...
      function s() {
        ...
        if (e.params.loop) return o(n, !1), void o(t, !1);
      ...
      function p() {
        ...
        n.forEach((e) => o(e, "next")), i.forEach((e) => o(e, "prev"));
      }
      function c() {
      ...
      n("init", () => {
        !1 === e.params.navigation.enabled ? u() : (p(), s());
      }),
      ...
      function c() {
        ...
        p.forEach((t, r) => {
          if (
            ...
            let o = 1,
              s = 1;
            "horizontal" === i ? (o = r) : (s = r),
              t.querySelectorAll(F(n.progressbarFillClass)).forEach((t) => {
                (t.style.transform = `translate3d(0,0,0) scaleX(${o}) scaleY(${s})`),
    ...
    function ({ swiper: e, extendParams: t, on: n, emit: a }) {
      ...
      function A() {
        ...
        "string" == typeof i.el &&
          ...
          a &&
            ((o = a.querySelector(`.${e.params.scrollbar.dragClass}`)),
            o || ((o = h("div", e.params.scrollbar.dragClass)), a.append(o))),
    ...
    function ({ swiper: e, extendParams: t, on: n, emit: i }) {
      ...
      function x(t) {
        ...
        if (((o = !1), (s = !1), c.push(t), !(c.length < 2))) {
          if (((o = !0), (u.scaleStart = y()), !u.slideEl)) {
      ...
      function C(t) {
        ...
        let r, o, s, l, p, c, h, f, y, v, x, M, E, A, T, C, I, L;
        e.params.cssMode &&
          ((e.wrapperEl.style.overflow = "hidden"),
          ...
          void 0 === g.touchesStart.x && t
            ? ((r = t.pageX), (o = t.pageY))
            : ((r = g.touchesStart.x), (o = g.touchesStart.y));
        const S = "number" == typeof t ? t : null;
        1 === d && S && ((r = void 0), (o = void 0)),
          (n.scale =
            S || u.imageWrapEl.getAttribute("data-swiper-zoom") || i.maxRatio),
          (d =
            S || u.imageWrapEl.getAttribute("data-swiper-zoom") || i.maxRatio),
          !t || (1 === d && S)
            ? ((h = 0), (f = 0))
            : ((I = u.slideEl.offsetWidth),
              (L = u.slideEl.offsetHeight),
              (s = w(u.slideEl).left + a.scrollX),
              ...
              (x = y * n.scale),
              (M = v * n.scale),
              (E = Math.min(I / 2 - x / 2, 0)),
              (A = Math.min(L / 2 - M / 2, 0)),
              (T = -E),
              (C = -A),
              (h = p * n.scale),
              (f = c * n.scale),
          ...
          e.zoom.enabled &&
            (function () {
              ...
              0 !== h.x && (n = Math.abs((r - g.currentX) / h.x)),
                0 !== h.y && (i = Math.abs((s - g.currentY) / h.y));
              const l = Math.max(n, i);
              (g.currentX = r), (g.currentY = s);
          ...
          setTransition: function (t, n) {
            ...
            if (Array.isArray(a))
              for (r = 0; r < a.length; r += 1)
                a[r] !== n && a[r] instanceof i && s(a[r]);
            else a instanceof i && n !== a && s(a);
          },
        });
    },
    function ({ swiper: e, extendParams: t, on: n }) {
        ...
        n("afterInit", () => {
          e.params.a11y.enabled &&
            (() => {
              ...
              (c = r(c)),
                (u = r(u)),
                c && c.forEach((e) => f(e, o, t.nextSlideMessage)),
                u && u.forEach((e) => f(e, o, t.prevSlideMessage)),
                w() &&
        ...
        n("fromEdge toEdge afterInit lock unlock", () => {
          e.params.a11y.enabled &&
            (function () {
              ...
              const { nextEl: t, prevEl: n } = e.navigation;
              n && (e.isBeginning ? (c(n), s(n)) : (u(n), o(n))),
                t && (e.isEnd ? (c(t), s(t)) : (u(t), o(t)));
            })();
        }),
        n("paginationUpdate", () => {
          e.params.a11y.enabled &&
    ...
    function ({ swiper: e, extendParams: t, on: n }) {
      ...
      const o = (e) =>
        ...
        l = (t, n) => {
          ...
          let s;
          s = e.params.url ? new URL(e.params.url) : a.location;
          const l = e.slides[n];
          ...
          if (e.params.history.root.length > 0) {
            ...
            "/" === n[n.length - 1] && (n = n.slice(0, n.length - 1)),
              (d = `${n}/${t ? `${t}/` : ""}${d}`);
          } else s.pathname.includes(t) || (d = `${t ? `${t}/` : ""}${d}`);
          e.params.history.keepQuery && (d += s.search);
        ...
        d = (t, n, i) => {
          if (n)
            for (let a = 0, r = e.slides.length; a < r; a += 1) {
              const r = e.slides[a];
              if (o(r.getAttribute("data-history")) === n) {
        ...
        p = () => {
          (a = s(e.params.url)), d(e.params.speed, a.value, !1);
        };
      n("init", () => {
                ...
                a = () => {
                  const i =
                    "string" == typeof t.swiper
                      ...
                      : t.swiper;
                  if (i && i.swiper) (t.swiper = i.swiper), s(), l(!0);
                  else if (i) {
                    const n = (a) => {
                      (t.swiper = a.detail[0]),
                  ...
                  if (d.velocities.length > 1) {
                    ...
                    (e.velocity = i / r),
                      ...
                      Math.abs(e.velocity) < a.freeMode.minimumVelocity &&
                        (e.velocity = 0),
                      (r > 150 || s() - t.time > 300) && (e.velocity = 0);
                  } else e.velocity = 0;
          ...
          updateSlide: (t, r, o, s) => {
            ...
            if ("row" === c && l > 1) {
              const e = Math.floor(t / (l * p)),
                i = t - p * l * e,
                a = 0 === e ? l : Math.min(Math.ceil((o - e * p * l) / p), l);
              (m = Math.floor(i / a)),
                (g = i - m * a + e * l),
                (u = g + (m * n) / p),
                (r.style.order = u);
            ...
            r.style[s("margin-top")] = 0 !== m ? d && `${d}px` : "";
          },
          ...
          setTranslate: () => {
            ...
            for (let n = 0; n < t.length; n += 1) {
              ...
              const r = e.params.fadeEffect.crossFade
                ...
                o = ie(0, t);
              (o.style.opacity = r),
                (o.style.transform = `translate3d(${i}px, ${a}px, 0px)`);
            }
          },
          setTransition: (t) => {
        ...
        setTranslate: () => {
          ...
          for (let r = 0; r < t.length; r += 1) {
            ...
            e.params.flipEffect.limitRotation &&
              (s = Math.max(Math.min(o.progress, 1), -1));
            ...
            e.isHorizontal()
              ? n && (d = -d)
              : ((u = c), (c = 0), (p = -d), (d = 0)),
              (o.style.zIndex = -Math.abs(Math.round(s)) + t.length),
              a.slideShadows && i(o, s);
            const g = `translate3d(${c}px, ${u}px, 0px) rotateX(${p}deg) rotateY(${d}deg)`;
            ie(0, o).style.transform = g;
          }
        },
        setTransition: (t) => {
          const n = e.slides.map((e) => g(e));
              ...
              if (
                ...
                let e = o
                  ...
                  n = o
                    ? t.querySelector(".swiper-slide-shadow-right")
                    : t.querySelector(".swiper-slide-shadow-bottom");
                e || (e = re(0, t, o ? "left" : "top")),
                  n || (n = re(0, t, o ? "right" : "bottom")),
  ...
  const ue = (e, t, n) => {
      ...
      return (
        o.classList.add(`${n}-video-thumb`),
        o.setAttribute("data-index", `${n}-${t}`),
        o.setAttribute("id", `${n}-video-thumb-${t}`),
        (o.src = e.src),
        a.appendChild(o),
        i.appendChild(a),
        i
    ...
    ge = (e, t, ...n) => {
      ...
      o.classList.add("product-image"),
        o.setAttribute("style", `background-image: url("${e.img}")`),
        r.appendChild(o),
        a.appendChild(r);
      const s = document.createElement("div");
      s.classList.add("title-container");
    ...
    we = (e, t, n = "", i = !0, a) => {
      ...
      const o = document.createElement("div");
      if (
        (o.classList.add("gallery-widget-title"),
        (o.innerText = e),
        r.appendChild(o),
        i)
      ) {
      ...
      s.setAttribute("href", a.url),
        s.setAttribute("target", "_blank"),
        s.setAttribute("style", "text-decoration: none; color: white;"),
      ...
      return s.appendChild(l), r.appendChild(s), r;
    },
    fe = () => {
      const e = document.createElement("div");
      ...
      (r.src =
        ...
        i.appendChild(a);
      const o = document.createElement("div");
      o.classList.add("gallery-background-container");
      const s = document.createElement("div");
      s.classList.add("swiper"), s.classList.add("gallery-background");
      const l = document.createElement("div");
        ...
        se.forEach((e, t) => {
          const n = ((e, t, n) => {
            ...
            o.classList.add("video"),
              o.classList.add(`${n}-video`),
              o.setAttribute("id", `${n}-video-${t}`),
              o.setAttribute("data-container", `${n}`),
              (o.src = e.src),
              (o.type = "video/mp4"),
              ce
                ? ((o.preload = "auto"),
            ...
            (s.innerText = "Your browser does not support the video tag."),
              o.appendChild(s),
              r.appendChild(o),
              a.appendChild(r),
              i.appendChild(a);
            ...
            const {
              ...
              o.setAttribute("style", "fill: rgb(255, 255, 255);"),
                o.setAttribute(
                  "d",
      ...
      const I = ((e) => {
        ...
        const o = document.createElement("div");
        o.classList.add("product-text"),
          o.setAttribute("id", "info-sidebar-product-text"),
          (o.innerText = e.product.summary);
        const s = he(e.product.pros),
      ...
      const L = ((e) => {
        ...
        r.classList.add("product-title"),
          ...
          a.appendChild(r);
        const o = document.createElement("div");
        o.classList.add("brand-name");
        const s = document.createElement("div");
        s.classList.add("verified-icon-container");
      ...
      return t.appendChild(L), e.appendChild(t), e;
    };
  (() => {
    (() => {
    ...
    const e = document.querySelector("body"),
      t = ((e) => {
          ...
          e.forEach((e, t) => {
            const n = ((e, t, n) => {
              ...
              o.classList.add("video"),
                ...
                o.setAttribute("data-dynamic", `dynamic-video-${t}`),
                o.setAttribute("data-container", n),
                o.setAttribute("type", "video/mp4"),
                (o.id = `video-dynamic-${t}`),
                (o.src = e.src),
                (o.autoplay = !0),
                ce
                  ? ((o.preload = "auto"),
        ...
        const o = document.createElement("div");
        if ((o.classList.add("video-hover-area"), pe)) {
          const e = ((e) => {
            const t = document.createElement("div");
        ...
        const s = document.createElement("a");
        s.classList.add("video-product-info"),
          s.classList.add("pp-video-widget-track-link"),
          s.setAttribute("href", e[0].product.url),
          s.setAttribute("target", "_blank");
        const l = document.createElement("img");
    ...
    window.addEventListener("load", () => {
      ...
      const r = document.querySelector(".pp-gallery-container"),
        o = document.querySelector(".banner-content-wrapper"),
        s = document.querySelectorAll(".icon-cross"),
      ...
      function T(e) {
        const t = e.currentTarget.paramIndex,
          ...
          r = i[t].offsetWidth,
          o = n[t];
        let s = Math.round((o.currentTime / o.duration) * r);
        s && (a[t].style.width = `${s}px`);
      }
      function C(e) {
        const t = e.currentTarget.paramIndex,
          n = e.currentTarget.paramVideos,
      ...
      const S = (e, t = 0, n = null, i = null, a = null, r = null, o = !1) => {
          if (null != e || null != e) {
            e.currentTime = t;
            let s = e.play();
            void 0 !== s &&
        ...
        N = new X(".gallery-background", {
          direction: "vertical",
          enabled: !1,
        }),
        k = new X(".gallery-swiper", {
          direction: "vertical",
          loop: !0,
          enabled: !1,
          spaceBetween: 10,
          ...
          thumbs: { multipleActiveThumbs: !0, swiper: z },
      ...
      if (
        ...
        const oe = document.documentElement.clientHeight,
          se = 0.45 * oe;
        ...
        function we() {
          ...
          if (((pe = de - e.clientY), (de = e.clientY), le >= oe)) {
            if (le < de) return (me = !1), void fe();
            me = !0;
          }
          if (le > de && !i) {
            if (de <= se) return (me = !1), void fe();
            me = !0;
          } else {
      ...
      const D = document.querySelectorAll(".video[data-dynamic]"),
      ...
      (B = document.getElementById(
        ...
        (R = document.querySelector(".video-hover-area"));
      ...
      function K() {
        ce ||
          (H
            ? (D.forEach((e) => (e.muted = !1)),
              (G.style.display = "block"),
              (U.style.display = "none"),
              (H = !1))
            : (D.forEach((e) => (e.muted = !0)),
      ...
      R?.addEventListener("click", (e) => {
        if (J) return;
        R?.removeEventListener("mouseover", Q),
          R?.removeEventListener("mouseout", Q),
          (q = !1),
        ...
        R?.addEventListener("mouseover", Q),
        R?.addEventListener("mouseout", Q),
      ...
      const ee = new X(".dynamic-video-slider", {
        loop: !0,
      ...
      function te(e) {
        let i = e.target,
          o = i.dataset.index,
          s = i.classList.contains("image") ? "image" : "video";
        if (
          ...
          return;
        let l = D[ee.realIndex];
        "video" === s && (n = l.currentTime),
          new t(t.CONTAINER_DYNAMIC, 0).stopAll(),
          B &&
            ((G.style.display = "none"), (U.style.display = "block"), (H = !0)),
          W.length &&
            W[ee.realIndex] &&
            ((V[ee.realIndex].style.display = "none"),
            (Z[ee.realIndex].style.display = "block"));
        let d = "#" + s + "-" + o;
        k.enable(),
          N.enable(),
          (a = !0),
      ...
      A && (ee.allowTouchMove = !1),
        ...
        ((E <= 768 && !D.length) || (E <= 768 && A)) &&
          o?.classList.add("mobile-image");
      ...
      (onpopstate = function () {
        ...
        s.forEach((e) => e.addEventListener("click", ae));
