...
const videosGourmetEasy = [
  {
      ...
      "product": {
          ...
          "summary": "Skip peeling your garlic and make pressing faster with the Gourmet Easy Garlic Press. There are two garlic presses available - one for fine mincing and one for coarse mincing. You can buy both presses together in a combo set, or you can choose an individual press to purchase. Both presses use 100% FDA-approved stainless steel and will add the right amount of real garlic flavoring to your soups, dips, and marinades.",
          "pros": [
      ...
      similar_products: [
          ...
          },
          {
              ...
              "summary": "Garlic Press Stainless Steel - Garlic Mincer - No Need To Peel - Scandinavian Design Detachable for Easy Cleaning - Garlic Presser and Masher - Garlic Crusher with 5 Year Unconditional Warranty.",
              "pros": [
...
const videosHomeHeritage = [
  {
      ...
      "product": {
          ...
          "review": "Beautiful!  It’s a little messy while fluffing but that’s expected with a flocked tree.  These branches are so full and gorgeous.  I shopped around for a new tree for a long time and I’d hands down buy this one again!",
          "faq": {
              "answer": "This artificial christmas tree’s branches are made from soft PVC for a classic look.",
      ...
      similar_products: [
          ...
          },
          {
              ...
              "summary": "If you're looking for a convenient and stylish way to bring holiday cheer into your home, check out this Artificial Pencil Christmas Tree from Home Heritage. The slim design is perfect for smaller spaces, and the impressive 7-foot height will make a big impact in any room.",
              "pros": [
                  "Pre-strung lights",
                  " Sturdy metal stand ",
...
const videosOvenIgniter = [
  {
      ...
      "product": {
          ...
          "review": "My natural gas oven stopped working. It would not warm up at all. After some research I found the most likely problem was the igniter. I did some testing and verified this was the issue. There are some videos on the web that go into detail on different stove models. This part was straight forward to install and works great. Ahhh we can cook in our wonderful gas oven again just in time for the holidays.",
          "faq": {
              "answer": "This oven igniter replacement fits many gas stove makes and models including Electrolux #5303935066, Brown #1802A300 & #1802A303, GE #WB2X9998 & GE Profile, and other gas ranges by Whirlpool, Bosch, Frigidaire, some Kenmore models & more.",
